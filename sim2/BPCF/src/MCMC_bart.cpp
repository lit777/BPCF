...
List MCMC(
    ...
    NumericVector M1(n1), M0(n0), Y1(n1), Y0(n0), ePS(n);
    ...
    NumericVector Xcut_m1[P + 1], Xcut_m0[P + 1], Xcut[P], Xcut_y1[P + 3], Xcut_y0[P + 3]; // e.g. unique value of potential confounders
    for (int j = 0; j < P; j++)
    {
        NumericVector temp;
    ...
    for (int i = 0; i < n0; i++)
    {
      Xpred_m0(i, P) = rowMeans(predicted_PS)(idx0(i));
      Xpred_y0(i, P) = rowMeans(predicted_PS)(idx0(i));
    }
    for (int i = 0; i < n1; i++)
    {
      Xpred_m1(i, P) = rowMeans(predicted_PS)(idx1(i));
      Xpred_y1(i, P) = rowMeans(predicted_PS)(idx1(i));
    }
